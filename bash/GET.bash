...
_GET() {
    ...
    __GET_handle_options_flags

    case ${MYWORDS[$INDEX-1]} in
      -m)
        _GET_compreply "GET" "HEAD" "POST" "PUT" "DELETE" "CONNECT" "OPTIONS" "TRACE" "PATCH"
        return
      ;;
      -b)
      ;;
      ...
      ;;
      -o)
        _GET_compreply "text" "ps" "links" "html" "dump"
        return
      ;;
...
__comp_current_options() {
    ...
    if [[ -n $always || ${MYWORDS[$INDEX]} =~ ^- ]]; then
      ...
      __GET_dynamic_comp 'options' "$options_spec"

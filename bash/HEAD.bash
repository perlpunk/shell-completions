...
_HEAD() {
    ...
    __HEAD_handle_options_flags

    case ${MYWORDS[$INDEX-1]} in
      -m)
        _HEAD_compreply "GET" "HEAD" "POST" "PUT" "DELETE" "CONNECT" "OPTIONS" "TRACE" "PATCH"
        return
      ;;
      -b)
      ;;
      ...
      ;;
      -o)
        _HEAD_compreply "text" "ps" "links" "html" "dump"
        return
      ;;
...
__HEAD_dynamic_comp() {
    ...
    _HEAD_compreply ${comp[@]}
}

function __HEAD_handle_options() {
    local i j
    declare -a copy
...
__comp_current_options() {
    ...
    if [[ -n $always || ${MYWORDS[$INDEX]} =~ ^- ]]; then
      ...
      __HEAD_dynamic_comp 'options' "$options_spec"

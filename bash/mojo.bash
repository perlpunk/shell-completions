    ...
    *)
    ...
    case ${MYWORDS[0]} in
      _meta)
        ...
        1)
            __comp_current_options || return
            __mojo_dynamic_comp 'commands' 'completion'$'\t''Shell completion functions'$'\n''pod'$'\t''Pod documentation'
        ...
        *)
        ...
        case ${MYWORDS[1]} in
          completion)
            ...
            2)
                __comp_current_options || return
                __mojo_dynamic_comp 'commands' 'generate'$'\t''Generate self completion'
          ...
          pod)
            ...
            2)
                __comp_current_options || return
                __mojo_dynamic_comp 'commands' 'generate'$'\t''Generate self pod'
        ...
        *)
        ...
        case ${MYWORDS[1]} in
          _meta)
            ...
            2)
                __comp_current_options || return
                __mojo_dynamic_comp 'commands' 'completion'$'\n''pod'
            ...
            *)
            ...
            case ${MYWORDS[2]} in
              completion)
                ...
                3)
                    __comp_current_options || return
                    __mojo_dynamic_comp 'commands' 'generate'
